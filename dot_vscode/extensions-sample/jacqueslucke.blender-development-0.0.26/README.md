...
> [!WARNING]
> In some cases uninstalling addon using Blender Preferences UI interface [might lead to data loss](https://github.com/JacquesLucke/blender_vscode/blob/HEAD/EXTENSION-SUPPORT.md#uninstall-addon-and-cleanup)
...
VS code uses the [automatic logic to determine if you are using addon or extension](https://github.com/JacquesLucke/blender_vscode/blob/HEAD/EXTENSION-SUPPORT.md)
...
- Check [CHANGELOG](https://github.com/JacquesLucke/blender_vscode/blob/HEAD/CHANGELOG.md) for breaking changes.
...
See [DEVELOPMENT.md](https://github.com/JacquesLucke/blender_vscode/blob/HEAD/DEVELOPMENT.md)
