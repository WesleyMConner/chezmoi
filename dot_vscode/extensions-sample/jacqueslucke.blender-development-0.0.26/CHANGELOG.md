...
- Linux and MacOS: fixed `blender.executables` not showing when calling `Blender: Start` (introduced in [#179](https://github.com/JacquesLucke/blender_vscode/issues/179))
