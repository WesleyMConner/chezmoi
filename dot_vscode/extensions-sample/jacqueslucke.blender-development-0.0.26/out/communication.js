...
exports.RunningBlenders = exports.BlenderInstances = exports.BlenderInstance = void 0;
...
class BlenderInstance {
    ...
    async isResponsive(timeout = RESPONSIVE_LIMIT_MS) {
...
class BlenderInstances {
    ...
    async getResponsive(timeout = RESPONSIVE_LIMIT_MS) {
