...
exports.resolveIncludeFile = void 0;
 ...
 */
function resolveIncludeFile(target, page, cursor, catalog, antoraConfig) {
    ...
    if (RESOURCE_ID_DETECTOR_RX.test(target)) {
        ...
        resolved = catalog.getByPath({
            ...
            path: path_1.default.normalize(path_1.default.relative(antoraConfig.contentSourceRootFsPath, path_1.default.join(cursor.dir.toString(), target))),
        });
    }
    if (resolved) {
...
//# sourceMappingURL=resolveIncludeFile.js.map